...
class RuleBuilder {
    ...
    handleOperatorChange(selectElement) {
        ...
        const placeholders = {
            ...
            // Data enrichment
            'fetch_from_api': '{"endpoint": "https://api.example.com/data", "params": {"key": "value"}, "mapping": {"score": "credit_score"}}'
        };
        ...
        const hints = {
            ...
            // Data enrichment
            'fetch_from_api': 'Fetch data from external API and enrich context. Format: {"endpoint": "https://api.example.com/data", "params": {"key": "value"}, "mapping": {"api_field": "context_field"}}'
        };
